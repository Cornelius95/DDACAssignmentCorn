...
public class RegisterItemServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (category.equalsIgnoreCase("Raw Materials")) {
            price = intweight * intquantity * 10;
        } else if (category.equalsIgnoreCase("End Products")) {
            price = intweight * intquantity * 15;
        } else if (category.equalsIgnoreCase("Food & Beverage")) {
            price = intweight * intquantity * 25;
        }else{
            price = intweight * intquantity * 30;
        }
        session.setAttribute("price",price);

        Items i = new Items(name, category, quantity, weight, cus,price);
