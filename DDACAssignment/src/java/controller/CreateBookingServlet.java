    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try {
                ...
                String sql;
                sql = "INSERT INTO Items(ITEM_NAME,ITEM_CATEGORY,QUANTITY,WEIGHT,CID) VALUES ('" + i.getName() + "','" + i.getCategory() + "'," + Integer.parseInt(i.getQuantity()) + "," + Float.parseFloat(i.getWeight()) + "," + i.getC().getId() + ")";
                ...
                sql = "INSERT INTO Booking(CustomerName, IC, Source, Destination, ShipDate, STATUS) VALUES('" + c.getName() + "','" + c.getIc() + "','" + s.getSource() + "','" + s.getDestination() + "','" + s.getShipdate() + "','" + status + "')";
                stmt.executeUpdate(sql);
                stmt.close();
