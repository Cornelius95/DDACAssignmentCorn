<%-- 
    Document   : homepage
    Created on : June 20, 2018, 6:00:38 PM
    Author     : cornelius_wong
--%>
...
<html>
    <head>
        <title>Maersk Line Welcome Page</title>
        <meta charset="utf-8">
        ...
        <div id="myCarousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="item active">
                    <img src="Cover1.jpg" alt="agent" width="900" height="500">
                    <div class="carousel-caption" >
                        <h1>Agent Portal</h1>
                        <p>Welcome to Maersk Line Container Management System (MLCMS)</p>
                ...
                <div class="item">
                    <img src="Cover2.jpg" alt="Admin" width="900" height="500">
                    <div class="carousel-caption" >
                        <h1>Login as Admin</h1>
                        <br>
                        <div><button id="toportpage" type="submit" class="btn btn-block">Navigate to Admin Login Page! 
                            </button></div>
                        <script>
                            document.getElementById("toportpage").onclick = function () {
                                location.href = "portloginpage.jsp";
                            };
                        </script>
                    </div>      
                </div>
            ...
            <div id="contact" class="container">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <p>Drop a note.</p>
                        <p><span class="glyphicon glyphicon-map-marker"></span>Menara Maerskline, Kuala Lumpur</p>
                        <p><span class="glyphicon glyphicon-phone"></span>Phone: +60123456789</p>
                        <p><span class="glyphicon glyphicon-envelope"></span>Email: customercare@maersk.com</p>
                    </div>
                    <div class="col-md-8">
                        <form action="FeedbackServlet" method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-12 form-group">
                                    <button class="btn pull-right" type="submit">Submit Feedback</button>
                                </div>
                            </div>
                        </form>
                    </div>
