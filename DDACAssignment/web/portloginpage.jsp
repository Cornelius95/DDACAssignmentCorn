        ...
        <nav class="navbar navbar-default navbar-fixed-top">
            <div class="container-fluid">
                <div class="navbar-header">
                    <a class="navbar-brand" href="portloginpage.jsp"><img style="opacity: 0.8" alt="MaerskLine" src="logo.png" width="150" height="65"></a>
        ...
        <div id="myCarousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                ...
                <div class="item">
                    ...
                    <div class="carousel-caption" >
                        <h1>Login in as Customer user</h1>
                        <br>
                        <div><button id="tocustomerpage" type="submit" class="btn btn-block">Navigate to Agent Login Page! 
                            </button></div>
                        <script>
                            document.getElementById("tocustomerpage").onclick = function () {
