        ...
        <script>
            ...
            function checkbeforesubmit() {
                ...
                if (username == "Username Available!") {
                    ...
                    document.getElementById("regisemail").setCustomValidity('Username Not Available! Please another username');
                }
                validatePassword();
                check();
            }
                            ...
                            <div class="modal-body">
                                <form action="RegisterServlet" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="regisname" name="regisname" placeholder="Enter Agent Name" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="nation">Nation:</label>
                                        <input type="text" class="form-control" id="nation" name="nation" placeholder="Enter Nation" required>
                                    </div>
                                    <div class="form-group">
