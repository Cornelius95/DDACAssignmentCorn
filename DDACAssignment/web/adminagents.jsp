                ...
                <div id="contentbox" class="col-sm-6 text-justify">
                    <div class="searchbox">
                        ...
                        <div class="search-container">
                            <input type="text" placeholder="Enter Agent Name" name="search" id="keyword" onkeyup="search()" >

                            <a href="registerpage.jsp"><button class="btn btn-default">Add Agent</button></a>
